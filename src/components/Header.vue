   ...
   <header class="py-3 flex justify-center items-center">
         <div class="flex justify-between items-center 2xl:container md:mx-auto">
            ...
            <div class="flex items-center gap-3 md:gap-5">
                <div class="flex justify-center items-center rounded-xl shadow-xl py-2 px-5 dark:text-slate-50 dark:bg-slate-700"> 
                    <a  class="mr-2">Sign in</a>
                    <div class="w-8  md:w-8  bg-gray-500 rounded-full overflow-hidden">
                        <img class="w-full h-full object-cover"  src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" alt="Avatar" />
                    </div>
                </div>
          
                <div class="flex justify-center items-center rounded-xl shadow-xl p-2 dark:text-slate-50 dark:bg-slate-700">
                    <!-- sun icon -->
